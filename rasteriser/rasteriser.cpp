...
void DrawPolygon( screen* screen, const vector<Vertex>& vertices,
    ...
    float w0_row = edgeFunction(V1, V2, P) / area;
    float w1_row = edgeFunction(V2, V0, P) / area;
    float w2_row = edgeFunction(V0, V1, P) / area;
    float w0, w1, w2;

    float A01 = (V1.y - V0.y) / area;
    float B01 = (V0.x - V1.x) / area;
    float A12 = (V2.y - V1.y) / area;
    float B12 = (V1.x - V2.x) / area;
    float A20 = (V0.y - V2.y) / area;
    float B20 = (V2.x - V0.x) / area;
